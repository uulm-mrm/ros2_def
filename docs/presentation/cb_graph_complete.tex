...
\begin{tikzpicture}[node font=\footnotesize]
    ...
    \node [callback, draw=gray, dashed] (bufferm2) at (6,-3) {Buffer\\M};
    \node [callback] (p1rx2) at (6,-6) {P1\\Rx M};
    \node [callback] (p2rx2) at (9,-6) {P2\\Rx M};
    \node [callback, draw=gray, dashed] (bufferd12) at (6,-9) {Buffer\\D1};
    \node [callback, draw=gray, dashed] (bufferd22) at (9,-9) {Buffer\\D2};
